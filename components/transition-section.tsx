  ...
  return (
    <section id="experience" className="relative h-[80vh] w-full overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img src="/7.jpg" alt="CJ6 on runway" className="w-full h-full object-cover" />
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto font-light leading-relaxed">
          The CJ6 isn't just a page in aviation history — it's a living, breathing machine you can touch, hear, and fly. At Nanchang Yaohu Flight Base, we bring 68 years of aeronautical heritage within your reach.
        </p>
      </div>
